...
create cached table T_ROUTE ( RTE_ID_C varchar(36) not null, RTE_IDDOCUMENT_C varchar(36) not null, RTE_NAME_C varchar(50) not null, RTE_STATUS_C varchar(20) not null default 'ACTIVE', RTE_ENDDATE_D timestamp, RTE_IDUSER_C varchar(36) not null, RTE_CREATEDATE_D timestamp not null, RTE_DELETEDATE_D timestamp, primary key (RTE_ID_C) );
create cached table T_ROUTE_STEP ( RTP_ID_C varchar(36) not null, RTP_IDROUTE_C varchar(36) not null, RTP_NAME_C varchar(200) not null, RTP_TYPE_C varchar(50) not null, RTP_TRANSITION_C varchar(50), RTP_COMMENT_C varchar(500), RTP_TRANSITIONS_C varchar(2000), RTP_IDTARGET_C varchar(36) not null, RTP_IDVALIDATORUSER_C varchar(36), RTP_ORDER_N int not null, RTP_CREATEDATE_D timestamp not null, RTP_ENDDATE_D timestamp, RTP_DELETEDATE_D timestamp, primary key (RTP_ID_C) );
create memory table T_ROUTE_MODEL_TARGET ( RMT_ID_C varchar(36) not null, RMT_IDROUTEMODEL_C varchar(36) not null, RMT_IDTARGET_C varchar(36) not null, RMT_TYPE_C varchar(10) not null, RMT_CREATEDATE_D timestamp not null, primary key (RMT_ID_C) );
...
alter table T_ROUTE add constraint FK_RTE_IDUSER_C foreign key (RTE_IDUSER_C) references T_USER (USE_ID_C) on delete restrict on update restrict;
...
alter table T_ROUTE_MODEL_TARGET add constraint FK_RMT_IDROUTEMODEL_C foreign key (RMT_IDROUTEMODEL_C) references T_ROUTE_MODEL (RTM_ID_C) on delete restrict on update restrict;
create index IDX_RMT_IDTARGET_C on T_ROUTE_MODEL_TARGET (RMT_IDTARGET_C);
...
insert into T_ROUTE_MODEL_TARGET (RMT_ID_C, RMT_IDROUTEMODEL_C, RMT_IDTARGET_C, RMT_TYPE_C, RMT_CREATEDATE_D) values ('rmt-default-route-0', 'default-document-review', 'administrators', 'GROUP', now());
insert into T_ROUTE_MODEL_TARGET (RMT_ID_C, RMT_IDROUTEMODEL_C, RMT_IDTARGET_C, RMT_TYPE_C, RMT_CREATEDATE_D) values ('rmt-default-route-1', 'default-document-review', 'administrators', 'GROUP', now());
insert into T_ROUTE_MODEL_TARGET (RMT_ID_C, RMT_IDROUTEMODEL_C, RMT_IDTARGET_C, RMT_TYPE_C, RMT_CREATEDATE_D) values ('rmt-default-route-2', 'default-document-review', 'administrators', 'GROUP', now());

update T_CONFIG set CFG_VALUE_C = '42' where CFG_ID_C = 'DB_VERSION';
