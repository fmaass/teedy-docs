...
create cached table T_ROUTE ( RTE_ID_C varchar(36) not null, RTE_IDDOCUMENT_C varchar(36) not null, RTE_NAME_C varchar(50) not null, RTE_STATUS_C varchar(20) not null default 'ACTIVE', RTE_ENDDATE_D datetime, RTE_IDUSER_C varchar(36) not null, RTE_CREATEDATE_D datetime not null, RTE_DELETEDATE_D datetime, primary key (RTE_ID_C) );
create cached table T_ROUTE_STEP ( RTP_ID_C varchar(36) not null, RTP_IDROUTE_C varchar(36) not null, RTP_NAME_C varchar(200) not null, RTP_TYPE_C varchar(50) not null, RTP_TRANSITION_C varchar(50), RTP_COMMENT_C varchar(500), RTP_TRANSITIONS_C varchar(2000), RTP_IDTARGET_C varchar(36) not null, RTP_IDVALIDATORUSER_C varchar(36), RTP_ORDER_N int not null, RTP_CREATEDATE_D datetime not null, RTP_ENDDATE_D datetime, RTP_DELETEDATE_D datetime, primary key (RTP_ID_C) );
create memory table T_ROUTE_MODEL_TARGET ( RMT_ID_C varchar(36) not null, RMT_IDROUTEMODEL_C varchar(36) not null, RMT_IDTARGET_C varchar(36) not null, RMT_TYPE_C varchar(10) not null, RMT_CREATEDATE_D datetime not null, primary key (RMT_ID_C) );
