...
create memory table T_OIDC_STATE ( OIS_ID_C varchar(36) not null, OIS_NONCE_C varchar(36) not null, OIS_CODEVERIFIER_C varchar(128), OIS_RETURNURL_C varchar(2000), OIS_CREATEDATE_D timestamp not null, primary key (OIS_ID_C) );
