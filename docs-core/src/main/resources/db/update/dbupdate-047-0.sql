create cached table T_FAVORITE ( FAV_ID_C varchar(36) not null, FAV_IDUSER_C varchar(36) not null, FAV_IDDOCUMENT_C varchar(36) not null, FAV_CREATEDATE_D timestamp not null, primary key (FAV_ID_C) );
