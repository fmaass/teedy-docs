create cached table T_SAVED_FILTER ( SFL_ID_C varchar(36) not null, SFL_IDUSER_C varchar(36) not null, SFL_NAME_C varchar(100) not null, SFL_QUERY_C varchar(2000) not null, SFL_CREATEDATE_D timestamp not null, primary key (SFL_ID_C) );
