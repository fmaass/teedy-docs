...
public class RouteDao {
    ...
    public String create(Route route, String userId) {
        ...
        // Set the initiator and initial status
    ...
    /**
     * End a route by setting its terminal status and end date.
     *
     * @param routeId Route ID
     * @param status Terminal status
     */
    public void endRoute(String routeId, RouteStatus status) {
        EntityManager em = ThreadLocalContext.get().getEntityManager();
        Query q = em.createNativeQuery("update T_ROUTE r set RTE_STATUS_C = :status, RTE_ENDDATE_D = :endDate where r.RTE_ID_C = :routeId and r.RTE_DELETEDATE_D is null");
