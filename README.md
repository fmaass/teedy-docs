...
- Latest stable version: `ghcr.io/fmaass/teedy-docs:v3.8.6`
...
services:
  teedy-server:
    image: ghcr.io/fmaass/teedy-docs:v3.8.6
...
version tag (e.g. `ghcr.io/fmaass/teedy-docs:v3.8.6`) as shown in the **Installation** compose examples.
