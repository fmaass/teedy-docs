...
- Latest stable version: `ghcr.io/fmaass/teedy-docs:v3.8.4`
...
services:
  teedy-server:
    image: ghcr.io/fmaass/teedy-docs:v3.8.4
...
version tag (e.g. `ghcr.io/fmaass/teedy-docs:v3.8.4`) as shown in the **Installation** compose examples.
