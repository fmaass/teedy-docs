...
- Latest stable version: `ghcr.io/fmaass/teedy-docs:v3.7.1`
...
services:
  teedy-server:
    image: ghcr.io/fmaass/teedy-docs:v3.7.1
...
version tag (e.g. `ghcr.io/fmaass/teedy-docs:v3.7.1`) as shown in the **Installation** compose examples.
