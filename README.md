...
- Latest stable version: `ghcr.io/fmaass/teedy-docs:v3.8.10`
...
services:
  teedy-server:
    image: ghcr.io/fmaass/teedy-docs:v3.8.10
...
version tag (e.g. `ghcr.io/fmaass/teedy-docs:v3.8.10`) as shown in the **Installation** compose examples.
