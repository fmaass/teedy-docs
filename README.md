...
- Latest stable version: `ghcr.io/fmaass/teedy-docs:v3.8.0`
...
services:
  teedy-server:
    image: ghcr.io/fmaass/teedy-docs:v3.8.0
...
version tag (e.g. `ghcr.io/fmaass/teedy-docs:v3.8.0`) as shown in the **Installation** compose examples.
