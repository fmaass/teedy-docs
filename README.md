...
- Latest stable version: `ghcr.io/fmaass/teedy-docs:v3.7.2`
...
services:
  teedy-server:
    image: ghcr.io/fmaass/teedy-docs:v3.7.2
...
version tag (e.g. `ghcr.io/fmaass/teedy-docs:v3.7.2`) as shown in the **Installation** compose examples.
